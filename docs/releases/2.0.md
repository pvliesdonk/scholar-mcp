...
<!-- notes-range-end: ec7991393842a2596f6a6b54de204d6146c4cab8 -->
...
the standards sources keep serving, and a `503` from `/health/ready` takes the
whole server out of rotation for a condition that restarting it cannot repair.
The `health_checks` dict stays empty, and the README records why so the emptiness
