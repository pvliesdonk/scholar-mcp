...
- report S2 key health through get_server_info (#393)

### Bug Fixes

- report upstream failures instead of answering with a gap (#375)
- report a refused Google Books lookup as distinct from not_found (#377)
- retry a refused keepalive ping and escalate sustained refusal (#378)
- parse the document-format shape EPO actually sends (#380)
- download every page of a patent PDF, not just the first (#381)
- parse the legal-event shape OPS actually sends (#392)
...
## 1.9.1-rc.1 (2026-08-22)



## 1.9.1-rc.0 (2026-08-22)
