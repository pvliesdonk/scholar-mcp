...
See [Configuration](https://pvliesdonk.github.io/scholar-mcp/1.10/configuration/index.md) for the full reference. Key variables for Docker:
...
For OIDC authentication, see [OIDC deployment](https://pvliesdonk.github.io/scholar-mcp/1.10/deployment/oidc/index.md).

Running behind a reverse proxy on a path prefix (`https://mcp.example.com/myservice/mcp`) rather than its own hostname needs two routing rules, one of which sits outside the prefix: see [Subpath Deployments](https://pvliesdonk.github.io/scholar-mcp/1.10/deployment/oidc/#subpath-deployments).
