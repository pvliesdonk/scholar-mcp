...
See [Installation](https://pvliesdonk.github.io/scholar-mcp/1.10/installation/index.md) for all methods including Linux packages.
...
- [Installation](https://pvliesdonk.github.io/scholar-mcp/1.10/installation/index.md): all installation methods
- [Configuration](https://pvliesdonk.github.io/scholar-mcp/1.10/configuration/index.md): environment variable reference
- [Tools](https://pvliesdonk.github.io/scholar-mcp/1.10/tools/index.md): full tool reference with parameters
- [Claude Code plugin](https://pvliesdonk.github.io/scholar-mcp/1.10/guides/claude-code-plugin/index.md): install as a Claude Code plugin
- [Claude Desktop setup](https://pvliesdonk.github.io/scholar-mcp/1.10/guides/claude-desktop/index.md): get started with Claude Desktop
- [Docker deployment](https://pvliesdonk.github.io/scholar-mcp/1.10/deployment/docker/index.md): production Docker Compose setup
