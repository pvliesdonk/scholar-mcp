...
| `SCHOLAR_MCP_BEARER_TOKENS_FILE`       | *(none)*      | Path to a TOML file mapping bearer tokens to per-caller subjects. When set, takes precedence over `SCHOLAR_MCP_BEARER_TOKEN`. See [Mapped bearer tokens](https://pvliesdonk.github.io/scholar-mcp/1.10/guides/authentication/#mapped-bearer-tokens-multi-subject) in the authentication guide.        |
...
See [Authentication guide](https://pvliesdonk.github.io/scholar-mcp/1.10/guides/authentication/index.md) for setup instructions and [OIDC deployment](https://pvliesdonk.github.io/scholar-mcp/1.10/deployment/oidc/index.md) for provider-specific configuration.
...
See [Docker deployment → Remote debugging](https://pvliesdonk.github.io/scholar-mcp/1.10/deployment/docker/#remote-debugging) for the IDE-attach walkthrough.
