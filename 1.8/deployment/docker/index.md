...
See [Configuration](https://pvliesdonk.github.io/scholar-mcp/1.8/configuration/index.md) for the full reference. Key variables for Docker:
...
For OIDC authentication, see [OIDC deployment](https://pvliesdonk.github.io/scholar-mcp/1.8/deployment/oidc/index.md).
