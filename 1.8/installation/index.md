...
See [Claude Code Plugin guide](https://pvliesdonk.github.io/scholar-mcp/1.8/guides/claude-code-plugin/index.md) for configuration and details.
...
The image is available for `linux/amd64` and `linux/arm64`. See [Docker deployment](https://pvliesdonk.github.io/scholar-mcp/1.8/deployment/docker/index.md) for Docker Compose with docling-serve.
...
See [systemd deployment](https://pvliesdonk.github.io/scholar-mcp/1.8/deployment/systemd/index.md) for configuration details.
