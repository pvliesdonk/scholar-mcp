...
See [Claude Code Plugin guide](https://pvliesdonk.github.io/scholar-mcp/2.0/guides/claude-code-plugin/index.md) for configuration and details.
...
The image is available for `linux/amd64` and `linux/arm64`. See [Docker deployment](https://pvliesdonk.github.io/scholar-mcp/2.0/deployment/docker/index.md) for Docker Compose with docling-serve.

The `latest` tag is the newest stable release. The rolling `edge` tag tracks every merge to `main` and carries no version identity; see [Image tags](https://pvliesdonk.github.io/scholar-mcp/2.0/deployment/docker/#image-tags) for the full list.
...
See [systemd deployment](https://pvliesdonk.github.io/scholar-mcp/2.0/deployment/systemd/index.md) for configuration details.
